...
layout: splash
permalink: /workshop/
title: "Mouse vs AI: Robust Foraging @ NeurIPS 2025"
header:
  overlay_color: "#5e616c"
  overlay_image: /assets/images/blueml_blurred.png
excerpt: >
  Sunday, December 7, 2025 · 11am - 2pm · Zoom<br />
---
<style>
.speaker-photo {
  width: 220px;
...
.speaker-grid { display: flex; flex-wrap: wrap; gap: 1.5rem; justify-content: space-around; margin-top: 1.5rem; }
.speaker-card { width: 360px; text-align: center; font-size: 0.95rem; }
